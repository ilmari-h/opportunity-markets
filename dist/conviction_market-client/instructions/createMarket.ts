...
> = {
  ...
  maxOptions: CreateMarketInstructionDataArgs["maxOptions"];
  totalShares: CreateMarketInstructionDataArgs["totalShares"];
    ...
    accounts.market.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getBytesEncoder().encode(
          new Uint8Array([
            99, 111, 110, 118, 105, 99, 116, 105, 111, 110, 95, 109, 97, 114,
            107, 101, 116,
          ]),
        ),
