...
export type VoteTokenAccount = {
  ...
  owner: Address;
  stateNonce: bigint;
  encryptedStateDisclosure: Array<ReadonlyUint8Array>;
...
/** Gets the encoder for {@link VoteTokenAccountArgs} account data. */
...
/** Gets the decoder for {@link VoteTokenAccount} account data. */
...
/** Gets the codec for {@link VoteTokenAccount} account data. */
...
export function getVoteTokenAccountSize(): number {
  return 137;
}
